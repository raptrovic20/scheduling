...
<h2><font color="white">BSIT Exam Schedule List</font></h2>
  ...
  <ul>
    ...
    <li  class="active"><a href="exam_BSIT.php"><font color="white">BSIT</a></font></li>
...
<div class="demo_jui">
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="log" class="jtable">
			...
			<tbody>
<?php $result=mysql_query("select * from schedule where CYS like '%BSIT%' and type='exam'")or die(mysql_error());
