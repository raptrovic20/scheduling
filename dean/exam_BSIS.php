...
<h2><font color="white">BISIS Faculty Schedule List</font></h2>
...
<div class="demo_jui">
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="log" class="jtable">
			...
			<tbody>
<?php $result=mysql_query("select * from schedule where CYS like '%BSIS%' and type='exam'")or die(mysql_error());
