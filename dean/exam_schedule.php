...
<br>
  ...
  <li><a href="schedule.php"><i class="icon-group icon-large"></i>Class Schedule</a></li>
   <li class="divider-vertical"></li>
    <li class="active"><a href="exam_schedule.php"><i class="icon-group icon-large"></i>Faculty Schedule</a></li>
   <li class="divider-vertical"></li>
...
<h2><font color="white">Faculty Schedule List</font></h2>
	<a class="btn btn-primary"  href="add_exam.php">  <i class="icon-plus-sign icon-large"></i>&nbsp;Add Faculty Schedule</a>
	<hr>
	<div class="pagination">
  <ul>
    <li class="active"><a href="exam_schedule.php"><font color="white">All</font></a></li>
    <li>
    ...
    <li><a href="exam_BSED.php"><font color="white">BSEd</font></a></li>
...
<div class="demo_jui">
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="log" class="jtable">
			...
			<tbody>
<?php $result=mysql_query("select * from schedule() where type='exam'")or die(mysql_error());
...
<tr class="del<?php echo $id ?>">
	...
	<a class="btn btn-info" href="edit_exam.php<?php echo '?id='.$id; ?>"><i class="icon-edit icon-large"></i>&nbsp;Edit</a>&nbsp;
