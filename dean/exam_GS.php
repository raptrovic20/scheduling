...
<h2><font color="white">Graduate School Exam Schedule List</font></h2>
  ...
  <ul>
    ...
    <li class="active"><a href="exam_GS.php"><font color="white">Graduate School</font></a></li>
  </ul>
</div>
...
<div class="demo_jui">
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="log" class="jtable">
			...
			<tbody>
<?php $result=mysql_query("select * from schedule where CYS like '%Graduate School%' and type='exam'")or die(mysql_error());
