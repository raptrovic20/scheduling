...
<h2><font color="white">Add Room</font></h2>
    ...
    <div class="controls">
    <input type="number" id="span9009" name="room_no"  style="margin: 0 auto;">
    </div>
    </div>
    ...
    <div class="controls">
    <input type="text" id="span9009" name="room_name" style="margin: 0 auto;">
    </div>
    </div>
    ...
    <div class="controls">
    <input type="text" id="span9009" name="location"  style="margin: 0 auto;">
    </div>
    </div>
    <div class="control-group">
