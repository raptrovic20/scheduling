...
<?php 
$result=mysql_query("select * from tbl_course")or die(mysql_error());
...
<tr class="del<?php echo $id ?>">
	...
	<a class="btn btn-info" href="edit_course.php<?php echo '?id='.$id; ?>"><i class="icon-edit icon-large"></i>&nbsp;Edit</a>&nbsp;
