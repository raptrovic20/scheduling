...
<script type="text/javascript">
	$(document).ready( function(){
		$('#search_button').click( function(){
			refresh_datatable($("#sem_filter").val(),$("#school_year_filter").val());
		});
	});
	
	function refresh_datatable(sem,school_year){
		$.ajax({
			url: "ajax_function.php",
			data: {function_name : 'refresh_room_sched_datatable', sem : sem, school_year : school_year},
			type: 'post',
			dataType: 'html',
